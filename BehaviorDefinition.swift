...
class BehaviorDefinition {
    ...
    func createBehavior(targetBrush:Brush){
        ...
        for transition in transitions{
            behaviorMapper.createStateTransition(transition.0, relative: targetBrush, eventName: transition.1, fromState:transition.2,toState:transition.3, condition: nil)
