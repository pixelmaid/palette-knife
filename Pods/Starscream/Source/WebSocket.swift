    ...
    */
    ...
    private func initStreamsWithData(_ data: Data, _ port: Int) {
        ...
        if disableSSLCertValidation {
            ...
            inStream.setProperty(settings, forKey: kCFStreamPropertySSLSettings as Stream.PropertyKey as Stream.PropertyKey.rawValue)
    ...
    public func stream(_ aStream: Stream, handle eventCode: Stream.Event) {
        if let sec = security where !certValidated && [.hasBytesAvailable, .hasSpaceAvailable].contains(eventCode) {
            let trust = aStream.property(forKey: kCFStreamPropertySSLPeerTrust as Stream.PropertyKey as Stream.PropertyKey.rawValue) as AnyObject
            let domain = aStream.property(forKey: kCFStreamSSLPeerName as Stream.PropertyKey as Stream.PropertyKey.rawValue) as? String
